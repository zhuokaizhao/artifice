...
class Artifice:
    ...
    def vis_test_raster(self):
        ...
        pose_name = 'figs/size_image_' + str(vis_number) +'.tiff'
        vis.save_raster(all_size_images[vis_number], pose_name)
        pose_name = 'figs/shape_image_' + str(vis_number) +'.tiff'
        vis.save_raster(all_shape_images[vis_number], pose_name)
